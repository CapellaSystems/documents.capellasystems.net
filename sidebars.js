...
const sidebars = {
  ...
  FTCSidebar: [
    ...
    },
    {
      ...
      label: 'Tutorials',
      items: [
        'Cambria FTC/Tutorials/Arib-std_b37_Captions_Extraction_and_Conversion/Arib-std_b37_Captions_Extraction_and_Conversion',
        'Cambria FTC/Tutorials/Audio_Watermarking_Integration_with_Kantar_Guide',
        'Cambria FTC/Tutorials/AMI_Creation_and_Editing/AMI_Creation_and_Editing',
        'Cambria FTC/Tutorials/Speech-To-Text_Filter',
        'Cambria FTC/Tutorials/Cluster_Redundancy_Feature',
        'Cambria FTC/Tutorials/Color_Space_Coversion/Color_Space_Coversion',
        'Cambria FTC/Tutorials/Delete_Source_after_Tanscoding/Delete_Source_after_Tanscoding',
        'Cambria FTC/Tutorials/AVID_Interplay/AVID_Interplay',
        'Cambria FTC/Tutorials/Trusted_Executables_and_Scripts',
        'Cambria FTC/Tutorials/Harmonic_VOS_Upload_Guide/Harmonic_VOS_Upload_Guide',
        'Cambria FTC/Tutorials/Logo_Filter/Logo_Filter',
        'Cambria FTC/Tutorials/NexGuard_Filter/NexGuard_Filter',
        'Cambria FTC/Tutorials/Database_Migration/Database_Migration',
        'Cambria FTC/Tutorials/Scriptable_Workflow/Scriptable_Workflow',
        'Cambria FTC/Tutorials/Subtitle_Burn-In_Workflow/Subtitle_Burn-In_Workflow',
        'Cambria FTC/Tutorials/SCTE-35_Insertion',
        'Cambria FTC/Tutorials/SNMP_Setup_and_Testing/SNMP_Setup_and_Testing',
        'Cambria FTC/Tutorials/Using_the_Teletrax_Watermarking_Filter/Using_the_Teletrax_Watermarking_Filter',
        'Cambria FTC/Tutorials/Video_Segments/Video_Segments',
        'Cambria FTC/Tutorials/Carbon_Subtitle_XML_Workflow/Carbon_Subtitle_XML_Workflow'
      ],
    },
    {
      type: 'category',
