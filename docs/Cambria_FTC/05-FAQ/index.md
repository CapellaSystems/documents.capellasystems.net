...
**A:** In Capella License Manager, under "Activation Tool," check "Use Offline Activation/Deactivation." Then send the generated request.txt file to support@capellasystems.net. We will provide an offlineResponse.dat file that you can use to complete the offline activation.  
